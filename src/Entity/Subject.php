...
class Subject
{
    ...
    #[ORM\ManyToMany(targetEntity: AcademicGrade::class, inversedBy: 'subjects')]
    #[ORM\JoinTable(name: 'academic_grade_subject')]
    ...
    {
        $this->academicGrades->removeElement($academicGrade);
